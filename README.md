...
Use a RADx mapping file (e.g. `templating_data/Tier1_Data_Dictionary.csv`) to create a template for generating CDE data.
...
# or
make template-global-codebook OUTPUT_PATH="cde_template.yaml"
```
